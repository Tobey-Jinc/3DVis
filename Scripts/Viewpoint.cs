...
public class Viewpoint : MonoBehaviour
{
    ...
    void Update()
    {
        Vector2 movementInput = new Vector2(getReal3D.Input.GetAxis("Forward"), getReal3D.Input.GetAxis("Strafe"));
    ...
    {
        Vector2 lookInput = new Vector2(getReal3D.Input.GetAxis("Pitch"), getReal3D.Input.GetAxis("Yaw"));
